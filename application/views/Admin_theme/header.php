...
<!-- Mirrored from demo.interface.club/limitless/layout_1/LTR/default/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 26 Jan 2017 04:50:48 GMT -->
			...
			<ul class="nav navbar-nav navbar-right">
				<li class="dropdown language-switch">
					<a class="dropdown-toggle" data-toggle="dropdown">
						<img src="<?=$theme_asset_url?>assets/images/flags/gb.png" class="position-left" alt="">
						English
						<span class="caret"></span>
					</a>

					<ul class="dropdown-menu">
						<li><a class="deutsch"><img src="<?=$theme_asset_url?>assets/images/flags/de.png" alt=""> Deutsch</a></li>
						<li><a class="ukrainian"><img src="<?=$theme_asset_url?>assets/images/flags/ua.png" alt=""> Українська</a></li>
						<li><a class="english"><img src="<?=$theme_asset_url?>assets/images/flags/gb.png" alt=""> English</a></li>
						<li><a class="espana"><img src="<?=$theme_asset_url?>assets/images/flags/es.png" alt=""> España</a></li>
						<li><a class="russian"><img src="<?=$theme_asset_url?>assets/images/flags/ru.png" alt=""> Русский</a></li>
					</ul>
				</li>
				...
				<li class="dropdown">
					...
					<div class="dropdown-menu dropdown-content width-350">
						...
						<ul class="media-list dropdown-content-body">
							<li class="media">
								<div class="media-left">
									<img src="<?=$theme_asset_url?>assets/images/demo/users/face10.jpg" class="img-circle img-sm" alt="">
							...
							<li class="media">
								<div class="media-left">
									<img src="<?=$theme_asset_url?>assets/images/demo/users/face3.jpg" class="img-circle img-sm" alt="">
							...
							<li class="media">
								<div class="media-left"><img src="<?=$theme_asset_url?>assets/images/demo/users/face24.jpg" class="img-circle img-sm" alt=""></div>
								<div class="media-body">
									<a href="#" class="media-heading">
							...
							<li class="media">
								<div class="media-left"><img src="<?=$theme_asset_url?>assets/images/demo/users/face4.jpg" class="img-circle img-sm" alt=""></div>
								<div class="media-body">
									<a href="#" class="media-heading">
							...
							<li class="media">
								<div class="media-left"><img src="<?=$theme_asset_url?>assets/images/demo/users/face25.jpg" class="img-circle img-sm" alt=""></div>
								<div class="media-body">
									<a href="#" class="media-heading">
